...
#chargesTable tbody tr:hover {
    background-color: #d4e3ff; /* Slightly darker blue */
...
/* Delete Button */
.delete {
    background: linear-gradient(135deg, #f44336, #d32f2f); /* Gradient Red */
    color: #fff;
    border: none;
    padding: 8px 16px;
    border-radius: 6px;
...
/* Save Button */
.save {
    background: linear-gradient(135deg, #2196F3, #1976D2); /* Gradient Blue */
    color: #fff;
    border: none;
    padding: 8px 16px;
    border-radius: 6px;
...
/* Add New Button */
.add-new {
    background: linear-gradient(135deg, #FF9800, #F57C00); /* Gradient Orange */
    color: #fff;
    border: none;
    padding: 12px 24px;
    border-radius: 8px;
